...
class OrderList {
    ...
    private func resetTamplateItem(itemNumber number: Int) {
        ...
        case 3:
            menuItems[3] = MenuItem(named: "Signature Noodle Soup", numbered: 3, itemType: .type1, pricedAt: 11.95, image: "3.jpg")
        case 4:
        ...
        case 6:
            menuItems[6] = MenuItem(named: "Signature Noodle Soup", numbered: 6, itemType: .type1, pricedAt: 11.95, image: "6.png")
        case 7:
